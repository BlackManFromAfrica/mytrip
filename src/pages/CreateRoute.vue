<template lang="">
  <div class="w-full">
    <v-text-field
      ...
      required
      color="secondary"
      class="w-1/5 text-white mt-5 ml-4"
    ></v-text-field>
    <v-container fluid>
      <v-textarea
        clearable
    ...
    >
      <div class="h-full flex justify-center items-center">
        <h1 v-if="list.length === 0" class="text-white flex flex-col w-fit">
          Выберите место
          <svg
            width="40"
            height="40"
  ...
  <v-btn @click="publish" class="w-full" variant="outlined" color="secondary">
    Опубликовать
  </v-btn>
</template>
<script>
